    ...
    <div className='text-white text-center'>
      <div className='max-w-[790px] mt-[-50px] w-full h-screen mx-auto flex flex-col justify-center'>
        ...
        <div className='justify-center flex space-x-4 font-mono'>
          <button className='rounded-lg bg-black border-2 border-cyan-50 text-lg px-2 py-1' onClick={sclink}>
            Script
          </button>
          <button className='rounded-lg bg-black border-2 border-cyan-50 text-lg px-2 py-1'>
